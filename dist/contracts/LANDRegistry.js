...
class LANDRegistry extends ethereum_1.Contract {
    constructor(address) {
        super(address, abi);
    ...
    static decodeLandData(data = '') {
        ...
        switch (version) {
            ...
            default:
                throw new DataError(`Unknown version when trying to decode land data: "${data}" (see https://github.com/decentraland/decentraland-eth/blob/master/docs/land-data.md)`);
        }
    }
    ...
    async updateManyLandData(coordinates, data) {
...
//# sourceMappingURL=LANDRegistry.js.map